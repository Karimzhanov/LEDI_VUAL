...
JAZZMIN_SETTINGS = {
    "site_title": "LEDI_VUAL",  # Заголовок админ-панели
    "site_header": "LEDI_VUAL",  # Заголовок на экране входа
    "site_brand": "LEDI_VUAL",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в LEDI_VUAL",  # Приветственное сообщение
    "site_title": "LEDI_VUAL",  # Заголовок админ-панели
    "site_header": "LEDI_VUAL",  # Заголовок на экране входа
    "site_brand": "LEDI_VUAL",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в LEDI_VUAL",  # Приветственное сообщение
